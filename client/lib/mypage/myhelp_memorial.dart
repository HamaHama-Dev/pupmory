...
/// 기억할개_코치마크
class MyHelpMemorialPage extends StatefulWidget {

  static Future<void> navigatorPush(BuildContext context) async {
    return Navigator.push<void>(
      context,
      MaterialPageRoute(
        builder: (_) => MyHelpMemorialPage(),
      ),
    );
  }

  @override
  _MyHelpMemorialPageState createState() => _MyHelpMemorialPageState();
}

class _MyHelpMemorialPageState extends State<MyHelpMemorialPage> {
                    ...
                    children: [
                      ...
                      Stack(
                        children: [
                          ...
                          if(nextPage == 0)...[
                            Padding(padding: EdgeInsets.only(left: 8, top: 145),
                              child: Container(
                                width: 260,
                                height: 575,
                                child: ClipRRect(
