...
/// 추억 작성하기
class WriteMemorialPage extends StatefulWidget {
  static Future<void> navigatorPush(BuildContext context) async {
    return Navigator.push<void>(
      context,
      MaterialPageRoute(
        builder: (_) => WriteMemorialPage(),
      ),
    );
  }

  @override
  _WriteMemorialPageState createState() => _WriteMemorialPageState();
}

class _WriteMemorialPageState extends State<WriteMemorialPage> {
                      ...
                      children: [
                        ...
                        InkWell(
                          onTap: () {
                            ...
                            if(setContent && setHashTag && setPlace && setTitle){
              ...
              child: SingleChildScrollView(
                ...
                Column(
                  ...
                  children: [
                    ...
                    // if(isPicSelected == false || _pickedImages.length <1)...[
                    //   Container(
                    //     width: screenSize.width,
                    //     height: 328,
                    //     child: Stack(
                    ...
                    //                     image: AssetImage('assets/images/memorial/memorial_upload.png')
                    //                 ),
                    ...
                    //             child:Text(
                    //               "갤러리에서 최대 9장의 사진을 선택할 수 있습니다.\n사진을 선택하려면 이곳을 탭하세요.",
                    //               textAlign: TextAlign.center,
                    //               style: TextStyle(
                    //                 color: Color(0xff99A8CB),
                    //                 fontSize: 14,
                    //               ),
                    //             ),
                    //           ),
                    ...
                    //                     ],),
                    //                   if(index == 0)...[
                    //                     Padding(padding: EdgeInsets.only(top: 85, left: 5),
                    //                       child: SvgPicture.asset(
                    //                         'assets/images/memorial/image_rep.svg',
                    //                       ),
                    //                     ),
                    ...
                    //       child: Row(children: [
                    //         SizedBox(width: 115,),
                    //         Image.asset('assets/images/memorial/upload_icon.png'),
                    //         SizedBox(width: 10,),
                    //         Text('사진 더 추가하기',  style: textStyle.white16normal,)
                    //       ],)
                    //   )
                    // ],
                    SizedBox(
