...
import 'memorial_main.dart' as userMain;
...
class WatchOthersPage extends StatefulWidget {
  @override
  State<WatchOthersPage> createState() => _WatchOthersPageState();
}

class _WatchOthersPageState extends State<WatchOthersPage> {
          ...
          child: new IconButton(
            ...
            onPressed: (){
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => MemorialSearchPage())); // 검색페이지로 이동
            },
          ),
            ),

          ],
          automaticallyImplyLeading: userMain.inUser? true : false,
          leading:
          Padding(padding: EdgeInsets.only(top:20),
            child: userMain.inUser? IconButton(
              icon: Icon(Icons.arrow_back_ios_rounded, color: Colors.black),
              onPressed: (){
                userMain.inUser = false;
                setState(() {
                });
                                                  ...
                                                  InkWell(
                                                    onTap: (){
                                                      ...
                                                      Navigator.push(
                                                          context,
                                                          MaterialPageRoute(
                                                              builder: (context) => WatchOthersMemorialDetailPage()));
                                                    },
                                                    child: Container(
                                                      // width: 156,
                                                      // height: 204,
